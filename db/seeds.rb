...
groceries = [
  { title: "Bag of Rice", description: "Unopened 1 kg bag of long-grain rice.", photo_urls: ["https://res.cloudinary.com/daadrtkvx/image/upload/v1764889335/Bag_of_Rice1_e8erws.png"] },
  { title: "Canned Beans", description: "Two cans of kidney beans, ready to heat.", photo_urls: ["https://res.cloudinary.com/daadrtkvx/image/upload/v1764889326/Canned_Beans1_g0nym4.png"] },
  { title: "Pasta Pack", description: "500 g pack of penne pasta, sealed and dry.", photo_urls: ["https://res.cloudinary.com/daadrtkvx/image/upload/v1764889328/Pasta_Pack1_tvdnuw.png"] },
  { title: "Olive Oil Bottle", description: "Extra-virgin olive oil in a glass bottle.", photo_urls: ["https://res.cloudinary.com/daadrtkvx/image/upload/v1764889328/Olive_Oil_Bottle1_uzotxi.png"] },
  { title: "Sugar Pack", description: "1 kg pack of white sugar for baking.", photo_urls: ["https://res.cloudinary.com/daadrtkvx/image/upload/v1764889334/Sugar_Pack1_msmz4f.png"] },
  { title: "Flour Bag", description: "1 kg bag of wheat flour, unopened.", photo_urls: ["https://res.cloudinary.com/daadrtkvx/image/upload/v1764889329/Flour_Bag1_ich8fg.png"] },
  ...
  { title: "Tomato Sauce Jar", description: "Jar of tomato sauce for pasta.", photo_urls: ["https://res.cloudinary.com/daadrtkvx/image/upload/v1764889335/Tomato_Sauce_Jar1_zyoetg.png"] },
  ...
  { title: "Peanut Butter Jar", description: "Unopened jar of smooth peanut butter.", photo_urls: ["https://res.cloudinary.com/daadrtkvx/image/upload/v1764889329/Peanut_Butter_Jar1_yvh5fu.png"] },
  { title: "Honey Bottle", description: "Bottle of natural honey, sealed.", photo_urls: ["https://res.cloudinary.com/daadrtkvx/image/upload/v1764889327/Honey_Bottle1_ontb2w.png"] },
